...
const int GL_FRAMEBUFFER = 30;
const int GL_RENDERBUFFER = 31;
const int GL_DEPTH_ATTACHMENT = 32;
const int GL_COLOR_ATTACHMENT0 = 33;
const int GL_DEPTH_COMPONENT16 = 34;
const int GL_RGB = 35;
const int GL_REPEAT = 36;
